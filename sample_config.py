...
class Config(object):
    LOGGER = True
    ALIVE_NAME = os.environ.get("ALIVE_NAME", "@aldelaimi")
    ...
    AUTONAME = os.environ.get("AUTONAME", "@aldelaimi")
    ...
    TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "aldelaimi")
